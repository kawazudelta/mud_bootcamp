# Tess Builder Mastermold v2.0

Version: 2.0  
Compiled: October 2025  
Author: TessMUD Design Protocol  

---

## Purpose

The Tess Builder Mastermold defines the complete workflow for designing unique Builder entities—AI-assisted creative contributors to the world of Tess.  
...
This document ensures the Builder creation process remains portable, transparent, and repeatable.
...
Each Builder Dossier is both a role prompt (for conversational interaction) and a design guide (for generating zones in Evennia).
...
All builders share a unified discipline born from the technical limits of Tess’s MUD engine.  
...
6. Ensure all language aligns with Tess’s high-concept fantasy tone.  
7. The Dossier should read as part personality profile, part design manual.

---

## Section 5: Legacy and Continuity

- Builders created before v2.0 (Abigail, Bradley, Cecily, Duke) are designated Legacy Builders.  
...
- v1.0: Initial protocol (Abigail through Duke)  
...
End of Tess Builder Mastermold v2.0
