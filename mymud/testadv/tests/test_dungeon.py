...
from .. import dungeon
from .mixins import TestAdvMixin


class TestDungeon(TestAdvMixin, BaseEvenniaTest):
    """
    ...
    def setUp(self):
        ...
        """
        super().setUp()
        droomclass = dungeon.TestAdvDungeonStartRoom
        ...
        self.assertEqual(
            self.start_room.scripts.get("testadv_dungeon_startroom_resetter")[0].interval, -1
        )
    ...
    def test_start_room(self):
        ...
        self.assertTrue(inherits_from(new_room_north, dungeon.TestAdvDungeonRoom))
